...
export default function ActiveConversationArea({
  ...
  return(
    <div className="flex flex-col h-full bg-background relative overflow-hidden font-sans">
          ...
          <div className="space-y-4 max-w-3xl mx-auto pb-6">
            {chatMessages?.length === 0 && (
              <div className="flex flex-col items-center justify-center pt-20 text-center">
                <div className="p-4 bg-background/80 backdrop-blur-sm rounded-2xl border shadow-sm max-w-xs">
            ...
            {chatMessages?.map((msg, index)=>{
              ...
              return(
                ...
                >
                  <div
                    className={`px-4 py-2.5 max-w-[85%] md:max-w-[70%] shadow-sm text-[15px] backdrop-blur-[2px]
                    ${isMe
                        ? "bg-primary/80 text-primary-foreground border border-primary/20 rounded-2xl rounded-tr-sm"
                        : "bg-background/90 border border-border text-foreground rounded-2xl rounded-tl-sm"
                      }
                  `}
                  >
      ...
      <footer className="p-4 bg-background border-t z-20">
        <form
